    ...
    if (flow?.ui) {
      ...
      return {
        github: {
          state: (
            oidcNodes.find(
              n => (n.attributes as UiNodeInputAttributes).value === "github",
        ...
        google: {
          state: (
            oidcNodes.find(
              n => (n.attributes as UiNodeInputAttributes).value === "google",
            )?.attributes as UiNodeInputAttributes
          ).name,
        },
      };
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col grow">
        <div className="min-w-96 self-center flex flex-col gap-4">
          {accounts?.github ? (
            <Button
              type="submit"
              name="link"
            ...
            >
              {accounts.github.state === "link" ? "Link" : "Unlink"} to GitHub
            </Button>
          ) : null}
          {accounts?.google ? (
            <Button
            ...
            >
              {accounts.google.state === "link" ? "Link" : "Unlink"} to Google
            </Button>
          ) : null}
        </div>
      </div>
